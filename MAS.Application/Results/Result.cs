...
namespace MAS.Application.Results;
...
public record Result
{
    ...
    public static FailureResult Failure(int statusCode, ErrorType error) =>
        new(statusCode, false, error, new List<string> { ResponseMessages.Error[error] });
    ...
    public static FailureResult Failure(ErrorType error) =>
        new(false, error, new List<string> { ResponseMessages.Error[error] });
